...
alter table live_market_snapshots add column if not exists model_prob_t20 numeric;
alter table live_market_snapshots add column if not exists model_prob_latest_pre_t8 numeric;
alter table live_market_snapshots add column if not exists model_prob_change_t20_to_t8 numeric;
alter table live_market_snapshots add column if not exists model_prob_changed_t20_to_t8 boolean not null default false;
alter table live_market_snapshots add column if not exists model_prob_last_refresh_at timestamptz;
alter table live_market_snapshots add column if not exists model_probability_update_count integer;
